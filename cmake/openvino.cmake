...
if (OPENVINO_DIRECTORY)
  ...
  set(OPENVINO_VERSION "2025.0.0.17942.1f68be9f594_x86_64")

  set(COMPRESSED_SUFFIX ".tgz")
  if(WIN32)
    set(OPENVINO_URL_PREFIX "https://storage.openvinotoolkit.org/repositories/openvino/packages/2025.0/windows/")
    set(OPENVINO_FILENAME "openvino_toolkit_windows_${OPENVINO_VERSION}")
    set(COMPRESSED_SUFFIX ".zip")
    if(NOT CMAKE_CL_64)
      message(FATAL_ERROR "FastDeploy cannot ENABLE_OPENVINO_BACKEND in win32 now.")
    endif()
  elseif(APPLE)
    set(OPENVINO_URL_PREFIX "https://storage.openvinotoolkit.org/repositories/openvino/packages/2025.0/macos/")
    if(CURRENT_OSX_ARCH MATCHES "arm64")
      message("Cannot compile with openvino while in osx arm64 platform right now")
    else()
      set(OPENVINO_FILENAME "openvino_toolkit_macos_12_6_${OPENVINO_VERSION}")
    endif()
  else()
    set(OPENVINO_URL_PREFIX "https://storage.openvinotoolkit.org/repositories/openvino/packages/2025.0/linux/")
    if(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "aarch64")
      ...
      if(NEED_ABI0)
        ...
        set(OPENVINO_FILENAME "openvino_toolkit_ubuntu22_${OPENVINO_VERSION}")
      endif()
    endif()
  endif()
